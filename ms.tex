...
To reduce thermal fluctuations while maintaining coherence, it is essential to average independent data sets obtained over the same region of sky with identical instrument settings. Hence, we select a subset of MWA snapshots pointed at zenith each of duration 112~seconds obtained over different nights which are aligned to within 72~seconds of each other in {\it local sidereal time} (LST) around a mean LST of 0.04~hours. The database contains 14 snapshots satisfying these criteria. Two of these snapshots, which contained amplitude and phase artifacts for a significant duration across different baselines, are excluded from our analysis. Results of this coherent averaging are discussed below.
...
\bibitem[{{Dillon} {et~al.}(2015){Dillon}, {Neben}, {Hewitt}, {Tegmark},
  ...
  {Riding}, {Sethi}, {Udaya Shankar}, {Subrahmanyan}, {Sullivan},
  {Thyagarajan}, {Tingay}, {Trott}, {Wayth}, {Webster}, {Wyithe}, {Bernardi},
  {Cappallo}, {Deshpande}, {Johnston-Hollitt}, {Kaplan}, {Lonsdale},
  {McWhirter}, {Morgan}, {Oberoi}, {Ord}, {Prabu}, {Srivani}, {Williams}, \&
  {Williams}}]{dil15}
{Dillon}, J.~S., {Neben}, A.~R., {Hewitt}, J.~N., {et~al.} 2015, ArXiv
  e-prints, arXiv:1506.01026
...
\bibitem[{{Neben} {et~al.}(2015){Neben}, {Bradley}, {Hewitt}, {Bernardi},
  ...
  {Mitchell}, {Morales}, {Morgan}, {Oberoi}, {Ord}, {Prabu}, {Udaya Shankar},
  {Srivani}, {Subrahmanyan}, {Tingay}, {Wayth}, {Webster}, {Williams}, \&
  {Williams}}]{neb15}
{Neben}, A.~R., {Bradley}, R.~F., {Hewitt}, J.~N., {et~al.} 2015, ArXiv
  e-prints, arXiv:1505.07114
...
\bibitem[{{Wayth} {et~al.}(2015){Wayth}, {Lenc}, {Bell}, {Callingham},
  ...
  {Hurley-Walker}, {Jackson}, {Johnston-Hollitt}, {Kapinska}, {McKinley},
  ...
  {Ord}, {Prabu}, {Rogers}, {Roshi}, {Udaya Shankar}, {Srivani},
  {Subrahmanyan}, {Tingay}, {Waterson}, {Webster}, {Whitney}, {Williams}, \&
  {Williams}}]{way15}
{Wayth}, R.~B., {Lenc}, E., {Bell}, M.~E., {et~al.} 2015, ArXiv e-prints,
  arXiv:1505.06041
